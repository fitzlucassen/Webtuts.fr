...
--
-- Client: localhost
-- Généré le: Lun 11 Février 2013 à 21:18
...
(289, 92, 'fr', 'Savoir gérer les sessions sur son site web !'),
(290, 92, 'en', 'How to manage sessions in your website !'),
(291, 93, 'fr', '<p><span>Sur un site, il peut parfois &ecirc;tre n&eacute;cessaire de transmettre des informations sur un utilisateur d&rsquo;une page &agrave; une autre. Pour cela on utilise en PHP les variables session.</span></p>\r\n<p><span>Les informations contenues dans ces variables sont stock&eacute;es dans des fichiers sur le serveur, contrairement aux cookies qui stockent les informations sur la machine de l&rsquo;utilisateur, ce qui offre donc un plus haut niveau de s&eacute;curit&eacute;.</span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 20px;">1 ) &nbsp; &nbsp;Ouverture d&rsquo;une session</span></p>\r\n<p><span>On cr&eacute;&eacute; une nouvelle session &agrave; l&rsquo;aide de la fonction session_start(). Il suffit d&rsquo;impl&eacute;menter cette fonction au d&eacute;but de votre page, avant le code HTML, afin d&rsquo;avoir acc&egrave;s aux variables de session.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_start()&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>Si un fichier existe sur le serveur pour cette session, les variables seront r&eacute;cup&eacute;r&eacute;es, sinon le fichier sera cr&eacute;&eacute;.</span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 22px;">2 ) &nbsp; &nbsp;Utilisation des variables de session</span></p>\r\n<p><span>Les variables sont accessibles via un tableau superglobal&nbsp;: $_SESSION.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_start()&nbsp;;</span><br /><span><span style="color: #a6e22e;">&nbsp; $_SESSION[</span><span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span><span style="color: #a6e22e;">] =</span><span style="color: #e6db74;"> &lsquo;Muusha&rsquo;</span>&nbsp;;</span><br /> <br /><span style="color: #a6e22e;">&nbsp; <span style="color: #f92673;">echo</span> <span style="color: #e6db74;">&lsquo;L&rsquo;utilisateur actuel est&nbsp;: &lsquo;</span>.$_SESSION[<span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span>]&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>Une fois la session d&eacute;marr&eacute;e, nous pouvons commencer &agrave; cr&eacute;er nos variables. Dans ce cas, la variable cr&eacute;&eacute;e est &laquo;&nbsp;pseudo&nbsp;&raquo; et elle contiendra la valeur que l&rsquo;on souhaite.</span><br /><span>Les noms de ces variables ne sont pas d&eacute;finis, on peut donc donner n&rsquo;importe quelle cl&eacute; au tableau $_SESSION.</span></p>\r\n<p><span>Ensuite, pour acc&eacute;der aux informations, il suffit de r&eacute;cup&eacute;rer la valeur contenue dans le tableau $_SESSION en pr&eacute;cisant la cl&eacute;.</span></p>\r\n<p><span>Les sessions ont une dur&eacute;e limit&eacute;e de 30 minutes par d&eacute;faut. Il est donc plus prudent de v&eacute;rifier si elle existe toujours. Pour cela il faut utiliser la fonction isset().</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; <span style="color: #f92673;">if</span>(<span style="color: #f92673;">isset</span>($_SESSION[<span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span>]))</span><br /><span style="color: #a6e22e;">&nbsp; &nbsp;<span style="color: #f92673;"> echo</span><span style="color: #e6db74;"> &lsquo;La variable existe.&rsquo;</span>&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 22px;">3 ) &nbsp; &nbsp;D&eacute;truire les variables et fermer une session.</span></p>\r\n<p><span>Il existe 2 fonctions pour d&eacute;truire les variables d&rsquo;une session.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_unset()&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; unset($_SESSION[</span><span style="color: #e6db74;">&lsquo;pseudo&rsquo;<span style="color: #a6e22e;">])&nbsp;;</span></span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>Le premier code a pour but de supprimer toutes les variables de la session en cours alors que le second permet de supprimer uniquement la variable pseudo de notre session.</span></p>\r\n<p><span>Pour fermer une session, il faut utiliser la fonction session_destroy().</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_destroy()&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>A noter, les sessions sont d&eacute;truites lors de la fermeture du navigateur.</span></p>'),
(292, 94, 'fr', 'Savoir gérer les sessions sur son site web !'),
(293, 94, 'en', 'How to manage sessions in your website !'),
(294, 95, 'fr', '<p><span>Sur un site, il peut parfois &ecirc;tre n&eacute;cessaire de transmettre des informations sur un utilisateur d&rsquo;une page &agrave; une autre. Pour cela on utilise en PHP les variables session.</span></p>\r\n<p><span>Les informations contenues dans ces variables sont stock&eacute;es dans des fichiers sur le serveur, contrairement aux cookies qui stockent les informations sur la machine de l&rsquo;utilisateur, ce qui offre donc un plus haut niveau de s&eacute;curit&eacute;.</span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 20px;">1 ) &nbsp; &nbsp;Ouverture d&rsquo;une session</span></p>\r\n<p><span>On cr&eacute;&eacute; une nouvelle session &agrave; l&rsquo;aide de la fonction session_start(). Il suffit d&rsquo;impl&eacute;menter cette fonction au d&eacute;but de votre page, avant le code HTML, afin d&rsquo;avoir acc&egrave;s aux variables de session.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_start()&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>Si un fichier existe sur le serveur pour cette session, les variables seront r&eacute;cup&eacute;r&eacute;es, sinon le fichier sera cr&eacute;&eacute;.</span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 22px;">2 ) &nbsp; &nbsp;Utilisation des variables de session</span></p>\r\n<p><span>Les variables sont accessibles via un tableau superglobal&nbsp;: $_SESSION.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_start()&nbsp;;</span><br /><span><span style="color: #a6e22e;">&nbsp; $_SESSION[</span><span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span><span style="color: #a6e22e;">] =</span><span style="color: #e6db74;"> &lsquo;Muusha&rsquo;</span>&nbsp;;</span><br /> <br /><span style="color: #a6e22e;">&nbsp; <span style="color: #f92673;">echo</span> <span style="color: #e6db74;">&lsquo;L&rsquo;utilisateur actuel est&nbsp;: &lsquo;</span>.$_SESSION[<span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span>]&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>Une fois la session d&eacute;marr&eacute;e, nous pouvons commencer &agrave; cr&eacute;er nos variables. Dans ce cas, la variable cr&eacute;&eacute;e est &laquo;&nbsp;pseudo&nbsp;&raquo; et elle contiendra la valeur que l&rsquo;on souhaite.</span><br /><span>Les noms de ces variables ne sont pas d&eacute;finis, on peut donc donner n&rsquo;importe quelle cl&eacute; au tableau $_SESSION.</span></p>\r\n<p><span>Ensuite, pour acc&eacute;der aux informations, il suffit de r&eacute;cup&eacute;rer la valeur contenue dans le tableau $_SESSION en pr&eacute;cisant la cl&eacute;.</span></p>\r\n<p><span>Les sessions ont une dur&eacute;e limit&eacute;e de 30 minutes par d&eacute;faut. Il est donc plus prudent de v&eacute;rifier si elle existe toujours. Pour cela il faut utiliser la fonction isset().</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; <span style="color: #f92673;">if</span>(<span style="color: #f92673;">isset</span>($_SESSION[<span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span>]))</span><br /><span style="color: #a6e22e;">&nbsp; &nbsp;<span style="color: #f92673;"> echo</span><span style="color: #e6db74;"> &lsquo;La variable existe.&rsquo;</span>&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 22px;">3 ) &nbsp; &nbsp;D&eacute;truire les variables et fermer une session.</span></p>\r\n<p><span>Il existe 2 fonctions pour d&eacute;truire les variables d&rsquo;une session.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_unset()&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; unset($_SESSION[</span><span style="color: #e6db74;">&lsquo;pseudo&rsquo;<span style="color: #a6e22e;">])&nbsp;;</span></span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>Le premier code a pour but de supprimer toutes les variables de la session en cours alors que le second permet de supprimer uniquement la variable pseudo de notre session.</span></p>\r\n<p><span>Pour fermer une session, il faut utiliser la fonction session_destroy().</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;">&lt;?php</span><br /><span style="color: #a6e22e;">&nbsp; session_destroy()&nbsp;;</span><br /><span style="color: #f92673;">?&gt;</span></span></p>\r\n<p><span>A noter, les sessions sont d&eacute;truites lors de la fermeture du navigateur.</span></p>'),
(295, 95, 'en', '<p>Soon...</p>'),
(296, 96, 'fr', 'Savoir gérer les sessions sur son site web !'),
(297, 96, 'en', 'How to manage sessions in your website !'),
(298, 97, 'fr', '<p><span>Sur un site, il peut parfois &ecirc;tre n&eacute;cessaire de transmettre des informations sur un utilisateur d&rsquo;une page &agrave; une autre. Pour cela on utilise en PHP les variables session.</span></p>\r\n<p><span>Les informations contenues dans ces variables sont stock&eacute;es dans des fichiers sur le serveur, contrairement aux cookies qui stockent les informations sur la machine de l&rsquo;utilisateur, ce qui offre donc un plus haut niveau de s&eacute;curit&eacute;.</span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 20px; color: #335681;">1 ) &nbsp; &nbsp;Ouverture d&rsquo;une session</span></p>\r\n<p><span>On cr&eacute;&eacute; une nouvelle session &agrave; l&rsquo;aide de la fonction session_start(). Il suffit d&rsquo;impl&eacute;menter cette fonction au d&eacute;but de votre page, avant le code HTML, afin d&rsquo;avoir acc&egrave;s aux variables de session.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;"><!--?php </span--><span style="font-family: ''courier new'', courier;">&lt;?php</span><br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; session_start()&nbsp;;</span><br /><span style="color: #f92673; font-family: ''courier new'', courier;">?&gt;</span></span></span></p>\r\n<p><span>Si un fichier existe sur le serveur pour cette session, les variables seront r&eacute;cup&eacute;r&eacute;es, sinon le fichier sera cr&eacute;&eacute;.</span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 22px; color: #335681;">2 ) &nbsp; &nbsp;Utilisation des variables de session</span></p>\r\n<p><span>Les variables sont accessibles via un tableau superglobal&nbsp;: $_SESSION.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;"><!--?php </span--><span style="font-family: ''courier new'', courier;">&lt;?php</span><br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; session_start()&nbsp;;</span><br /><span style="font-family: ''courier new'', courier;"><span style="color: #a6e22e;">&nbsp; $_SESSION[</span><span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span><span style="color: #a6e22e;">] =</span><span style="color: #e6db74;"> &lsquo;Muusha&rsquo;</span>&nbsp;;</span><br /> <br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; <span style="color: #f92673;">echo</span> <span style="color: #e6db74;">&lsquo;L&rsquo;utilisateur actuel est&nbsp;: &lsquo;</span>.$_SESSION[<span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span>]&nbsp;;</span><br /><span style="color: #f92673; font-family: ''courier new'', courier;">?&gt;</span></span></span></p>\r\n<p><span>Une fois la session d&eacute;marr&eacute;e, nous pouvons commencer &agrave; cr&eacute;er nos variables. Dans ce cas, la variable cr&eacute;&eacute;e est &laquo;&nbsp;pseudo&nbsp;&raquo; et elle contiendra la valeur que l&rsquo;on souhaite.</span><br /><span>Les noms de ces variables ne sont pas d&eacute;finis, on peut donc donner n&rsquo;importe quelle cl&eacute; au tableau $_SESSION.</span></p>\r\n<p><span>Ensuite, pour acc&eacute;der aux informations, il suffit de r&eacute;cup&eacute;rer la valeur contenue dans le tableau $_SESSION en pr&eacute;cisant la cl&eacute;.</span></p>\r\n<p><span>Les sessions ont une dur&eacute;e limit&eacute;e de 30 minutes par d&eacute;faut. Il est donc plus prudent de v&eacute;rifier si elle existe toujours. Pour cela il faut utiliser la fonction isset().</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;"><!--?php </span--><span style="font-family: ''courier new'', courier;">&lt;?php</span><br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; <span style="color: #f92673;">if</span>(<span style="color: #f92673;">isset</span>($_SESSION[<span style="color: #e6db74;">&lsquo;pseudo&rsquo;</span>]))</span><br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; &nbsp;<span style="color: #f92673;"> echo</span><span style="color: #e6db74;"> &lsquo;La variable existe.&rsquo;</span>&nbsp;;</span><br /><span style="color: #f92673; font-family: ''courier new'', courier;">?&gt;</span></span></span></p>\r\n<p><span style="font-family: ''Segoe UI light'', verdana; font-size: 22px; color: #335681;">3 ) &nbsp; &nbsp;D&eacute;truire les variables et fermer une session.</span></p>\r\n<p><span>Il existe 2 fonctions pour d&eacute;truire les variables d&rsquo;une session.</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;"><!--?php </span--><span style="font-family: ''courier new'', courier;">&lt;?php</span><br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; session_unset()&nbsp;;</span><br /><span style="color: #f92673; font-family: ''courier new'', courier;">?&gt;</span></span></span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e; font-family: ''courier new'', courier;"><!--?php </span--><span style="color: #f92673;"><!--?php </span-->&lt;?php<br /><span style="color: #a6e22e;">&nbsp; unset($_SESSION[</span><span style="color: #e6db74;">&lsquo;pseudo&rsquo;<span style="color: #a6e22e;">])&nbsp;;</span></span><br /><span style="color: #f92673;">?&gt;</span></span></span></p>\r\n<p><span>Le premier code a pour but de supprimer toutes les variables de la session en cours alors que le second permet de supprimer uniquement la variable pseudo de notre session.</span></p>\r\n<p><span>Pour fermer une session, il faut utiliser la fonction session_destroy().</span></p>\r\n<p style="margin-left: 30px;"><span style="color: #a6e22e;"><!--?php </span--><span style="color: #f92673;"><!--?php </span--><span style="font-family: ''courier new'', courier;">&lt;?php</span><br /><span style="color: #a6e22e; font-family: ''courier new'', courier;">&nbsp; session_destroy()&nbsp;;</span><br /><span style="color: #f92673; font-family: ''courier new'', courier;">?&gt;</span></span></span></p>\r\n<p><span>A noter, les sessions sont d&eacute;truites lors de la fermeture du navigateur.</span></p>'),
(299, 97, 'en', '<p>Soon</p>'),
