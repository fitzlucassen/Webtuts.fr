<div style="padding :20px;">
	...
	<form action="" method="post">
		...
		<div style="overflow: hidden;padding: 10px;">
			<input name="name" type="text" value="<?php lang($category->get("name")); ?>"/>
		</div>
		...
		<div style="overflow: hidden;padding: 10px;">
			<textarea name="description"><?php lang($category->get("description")); ?></textarea>
		</div>
		<div style="clear: left;">
		</div>
