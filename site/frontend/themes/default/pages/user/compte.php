...
<!-- compte content -->
	...
	<form action="" method="post" id="register-form">
		...
		<input type="checkbox" <?php echo (in_array("javascript", explode(",", $user->get("languages"))) ? "checked" : ""); ?> name="langage-javascript" value="js" id="langage-javascript" class="check-langage"/>
