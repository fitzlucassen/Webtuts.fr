...
class Sql {
	...
	public function insert($into) {
		...
		$this->requete .= "INSERT INTO ".$GLOBALS['_CONFIG_sql_prefix'].$into." ";
		return $this;
	}
	...
	public function update($table) {
		...
		$this->requete .= "UPDATE ".$GLOBALS['_CONFIG_sql_prefix'].$table." ";
		return $this;
	}
	...
	public function from($from, $fromMore=null) {
		...
		$this->requete .= "FROM ".$GLOBALS['_CONFIG_sql_prefix'].$from." ";
		if($fromMore!=null)
